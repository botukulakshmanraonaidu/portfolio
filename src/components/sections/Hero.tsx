...
import RoleTypewriter from "../common/RoleTypewriter";
import { useResume } from "@/hooks/useResume";

const Hero = () => {
  const { data: resumeUrl } = useResume();

  return (
    <section className="flex items-center justify-center relative overflow-hidden pt-32 pb-20">
      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="max-w-5xl mx-auto text-center">
          ...
          >
            ...
            Passionate about developing production-ready <span className="text-foreground font-medium">AI solutions</span>.
          </motion.p>
          ...
          >
            ...
            <a
              ...
              download="Lakshman Rao Botuku - devon.pdf"
