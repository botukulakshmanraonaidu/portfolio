              ...
              <div className="glass-card rounded-3xl p-8 lg:p-10 relative overflow-hidden">
                ...
                <div className="relative z-10 space-y-6">
                  <p className="text-muted-foreground text-lg leading-relaxed">
                    I'm an <span className="text-foreground font-semibold">AI & Backend Developer</span> with a strong foundation in Python,
                    NLP, RAG systems, and scalable backend services. Currently working at
                  ...
                  <p className="text-muted-foreground text-lg leading-relaxed">
                    ...
                    deploying data-driven applications with a focus on <span className="text-foreground font-medium">system design</span>.
