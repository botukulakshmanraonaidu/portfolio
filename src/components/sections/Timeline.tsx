...
const timelineData = [
  {
    type: "experience",
    title: "Software Developer (Trainee → Full-Time)",
              ...
              >
                ...
                <div className="absolute left-6 md:left-1/2 -translate-x-1/2 z-10">
                  <motion.div
                    ...
                    className={`w-12 h-12 rounded-full flex items-center justify-center shadow-lg ${item.type === "experience"
                ...
                {/* Content card */}
                <div
                  className={`ml-20 md:ml-0 md:w-[calc(50%-48px)] ${index % 2 === 0 ? "md:pr-12 md:text-right" : "md:pl-12 md:text-left"
                    }`}
                >
                  <motion.div
                    whileHover={{ y: -4 }}
