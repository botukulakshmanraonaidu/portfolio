...
const skillCategories = [
  ...
  },
  {
    ...
    skills: ["Python", "Django", "FastAPI", "PostgreSQL", "MySQL", "MongoDB", "Firebase"],
  },
  {
    title: "AI & ML Technologies",
    color: "from-purple-500 to-pink-500",
    skills: ["LangChain", "LlamaIndex", "HuggingFace", "OpenAI GPT", "TensorFlow", "Semantic Search"],
  },
];
...
const Skills = () => {
  ...
  return (
    <section id="skills" className="py-12 bg-secondary/10 relative overflow-hidden">
