      ...
      <div className="container mx-auto px-6 flex items-center justify-between">
        ...
        <div className="hidden md:flex items-center gap-0.5">
          ...
          <div className="ml-3 flex items-center gap-2">
            ...
            <a
              href="#contact"
              className="px-5 py-2.5 text-sm bg-primary text-primary-foreground rounded-lg font-semibold hover:shadow-[0_4px_20px_hsl(var(--primary)/0.4)] transition-all duration-300 hover:-translate-y-0.5"
            >
              Hire Me
            </a>
          </div>
        ...
        <div className="flex md:hidden items-center gap-2">
          <ThemeToggle />
          <button
            className="p-1.5 rounded-lg hover:bg-secondary/50 transition-colors text-foreground"
